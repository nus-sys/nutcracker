...
entry:
  %ipv41 = getelementptr inbounds nuw %struct.packet, ptr %pkt, i32 0, i32 1
  %tcp2 = getelementptr inbounds nuw %struct.packet, ptr %pkt, i32 0, i32 2
  %dstAddr = getelementptr inbounds nuw %struct.ipv4, ptr %ipv41, i32 0, i32 10
  %0 = load i32, ptr %dstAddr, align 4
  %dstPort = getelementptr inbounds nuw %struct.tcp, ptr %tcp2, i32 0, i32 1
  %1 = load i16, ptr %dstPort, align 2
  %protocol3 = getelementptr inbounds nuw %struct.ipv4, ptr %ipv41, i32 0, i32 7
  %2 = load i8, ptr %protocol3, align 1
...
if.then16:                                        ; preds = %lor.lhs.false, %land.lhs.true
  ...
  %dstAddr18 = getelementptr inbounds nuw %struct.ipv4, ptr %ipv41, i32 0, i32 10
...
if.end19:                                         ; preds = %if.end, %entry
  ...
  %ethernet32 = getelementptr inbounds nuw %struct.packet, ptr %pkt, i32 0, i32 0
