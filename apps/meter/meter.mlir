...
!main_metadata_t = !p4hir.struct<"main_metadata_t", flow_id: !b32i, color: !b8i>
!nc_standard_metadata_t = !p4hir.struct<"nc_standard_metadata_t", ingress_port: !b9i, egress_port: !b9i, packet_length: !b32i, drop: !b1i>
!proto_check_0_ = !p4hir.struct<"proto_check_0", hit: !p4hir.bool, miss: !p4hir.bool, action_run: !anon>
...
module {
  ...
  p4hir.control @MainControl(%arg0: !p4hir.ref<!main_headers_t> {p4hir.dir = #p4hir<dir inout>, p4hir.param_name = "hdr"}, %arg1: !p4hir.ref<!main_metadata_t> {p4hir.dir = #p4hir<dir inout>, p4hir.param_name = "meta"}, %arg2: !p4hir.ref<!nc_standard_metadata_t> {p4hir.dir = #p4hir<dir inout>, p4hir.param_name = "standard_meta"})() {
    %hash_unit_0 = p4hir.instantiate @Hash5Tuple() as "hash_unit_0" annotations {name = "MainControl.hash_unit"} : () -> !Hash5Tuple
    %c1024_b32i = p4hir.const #int1024_b32i
    %c0_b8i = p4hir.const #int0_b8i
    %flow_meter_0 = p4hir.instantiate @meter(%c1024_b32i, %c0_b8i) as "flow_meter_0" annotations {name = "MainControl.flow_meter"} : (!b32i, !b8i) -> !meter
    p4hir.func action @compute_flow_id() annotations {name = "MainControl.compute_flow_id"} {
      p4hir.scope {
        ...
        p4hir.call_method @Hash5Tuple::@apply (%hash_unit_0, %result_out_arg, %src_addr, %dst_addr, %src_port, %dst_port, %protocol) : !Hash5Tuple, (!p4hir.ref<!b32i>, !b32i, !b32i, !b16i, !b16i, !b8i) -> ()
        %val_7 = p4hir.read %result_out_arg : <!b32i>
        p4hir.assign %val_7, %flow_id_field_ref : <!b32i>
      }
      p4hir.return
    }
    p4hir.table @proto_check_0 annotations {name = "MainControl.proto_check"} {
      p4hir.table_key {
        %val = p4hir.read %arg0 : <!main_headers_t>
        %ipv4 = p4hir.struct_extract %val["ipv4"] : !main_headers_t
        %protocol = p4hir.struct_extract %ipv4["protocol"] : !ipv4_t
    ...
    p4hir.control_apply {
      ...
      p4hir.if %0 {
        %proto_check_0_apply_result = p4hir.table_apply @proto_check_0 : !proto_check_0_
        p4hir.scope {
          %val_2 = p4hir.read %arg1 : <!main_metadata_t>
          %flow_id = p4hir.struct_extract %val_2["flow_id"] : !main_metadata_t
          %color_field_ref = p4hir.struct_extract_ref %arg1["color"] : <!main_metadata_t>
          %result_out_arg = p4hir.variable ["result_out_arg"] : <!b8i>
          p4hir.call_method @meter::@execute_meter<[!b8i]> (%flow_meter_0, %flow_id, %result_out_arg) : !meter, (!b32i, !p4hir.ref<!b8i>) -> ()
          %val_3 = p4hir.read %result_out_arg : <!b8i>
          p4hir.assign %val_3, %color_field_ref : <!b8i>
        }
        %val_0 = p4hir.read %arg1 : <!main_metadata_t>
        %color = p4hir.struct_extract %val_0["color"] : !main_metadata_t
        %c2_b8i = p4hir.const #int2_b8i
        %eq_1 = p4hir.cmp(eq, %color, %c2_b8i) : !b8i, !p4hir.bool
        p4hir.if %eq_1 {
          %drop_field_ref = p4hir.struct_extract_ref %arg2["drop"] : <!nc_standard_metadata_t>
          %c-1_b1i = p4hir.const #int-1_b1i
          p4hir.assign %c-1_b1i, %drop_field_ref : <!b1i>
        }
      }
    }
  }
