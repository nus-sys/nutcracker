//===- BF3DRMTToDocaFlowPass.h - DOCA Flow C codegen from bf3drmt --------===//
//
// Reads all bf3drmt.mlir files in inputDir and generates
...
#ifndef BF3DRMT_TO_DOCA_FLOW_PASS_H
#define BF3DRMT_TO_DOCA_FLOW_PASS_H
...
/// Generate doca_flow_pipeline.c from the bf3drmt.mlir files in inputDir.
...
#endif // BF3DRMT_TO_DOCA_FLOW_PASS_H
